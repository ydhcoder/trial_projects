...
public class LengthConverter {
	...
	public static void main(String[] args) {
		...
		double inches, feet, yards, miles; // Measurement expressed in // each possible unit of // measure.
		...
		while (true) {
			...
			if (units.equals("inch") || units.equals("inches") || units.equals("in")) { 
				...
				TextIO.putln("Sorry, but I don’t understand \"" + units + "\"."); 
			...
			TextIO.putln(" miles"); TextIO.putln();

		} // end while

		TextIO.putln(); TextIO.putln("OK! Bye for now.");
