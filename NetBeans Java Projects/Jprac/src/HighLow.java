...
public class HighLow {
	...
	public static void main(String[] args) {
		...
		boolean playAgain;	// Record user�s response when user is
							// asked whether he wants to play // another game.
	...
	private static int play() {
		...
		/* To set up for the next iteration of the loop, 
		  the nextCard becomes the currentCard, since the currentCard has to be 
		  the card that the user sees, and the nextCard will be set to the next
	...
	TextIO.putln("You made " + correctGuesses + " correct predictions."); 
	TextIO.putln();
